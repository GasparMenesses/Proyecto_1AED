...
public interface TDALista<T> {
     ...
     *
     * <p>
     * Los elementos ubicados desde esa posición en adelante desplazan su índice
     * una posición hacia la derecha.</p>
     *
     ...
     *
     * <p>
     * Los elementos posteriores, si existen, desplazan su índice una posición
     ...
     *
     * <p>
     * La comparación del elemento queda sujeta al criterio definido por la
     * implementación, normalmente mediante {@code equals}.</p>
     *
     ...
     *
     * @param elem el elemento a buscar
     * @return el índice de la primera ocurrencia del elemento, o {@code -1} si
     ...
     * @return el primer elemento que cumple el criterio, o {@code null} si no
     * existe ninguno
     */
    T buscar(Predicate<T> criterio);

    /**
     * Retorna una nueva lista con los elementos ordenados según el comparador
     * dado.
     *
     * <p>
     ...
     *
     * <p>
     * Luego de invocar este método, la lista queda vacía.</p>
     */
    void vaciar();
}
